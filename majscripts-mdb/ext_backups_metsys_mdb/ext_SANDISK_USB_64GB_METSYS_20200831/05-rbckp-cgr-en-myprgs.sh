...
### Decription:
### 
### rsync backup /c/Users/gregor.redelonghi/myprogs
###
### UPDATE 20191023
...
# START
# tms; echo "-----------------------------------------------------------------------------"
(tms; echo "Backing up /c/Users/gregor.redelonghi/myprogs to ${gr_BEKAPD} ... ") | tee -a ${gr_LOGF}
(tms; echo "Syncing ...  ") | tee -a ${gr_LOGF}
${gr_RSO} --delete --exclude-from=${gr_DNBCKP} /c/Users/gregor.redelonghi/myprogs/ ${gr_BEKAPD}/myprogs_cugr_en/ | eval ${gr_FILT} | while read line; do(tms; echo $line); done
