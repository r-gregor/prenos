...
# 20260804 v3 -- renamed to fcopy-to-multiple-dirs.sh
# last: 20260804
# ---
...
usage: fcopy-to-multiple-dirs -f <fnm1> <fnm2> <"fnm3 with spaces"> -d <dirnm1> <dirnm2> ...
